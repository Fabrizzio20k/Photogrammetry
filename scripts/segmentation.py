...
# Función para debug específico


# Configuración recomendada para tu caso específico:
"""
segment_images_for_photogrammetry(
    input_folder="tu_carpeta",
    confidence=0.25,  # Más bajo para detectar más objetos
    min_area_ratio=0.08,  # Objetos deben ocupar al menos 8%
